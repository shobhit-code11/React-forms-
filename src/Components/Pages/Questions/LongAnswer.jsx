...
const LongAnswer = () => {
  ...
  return (
    <section className=" h-[400vh] lg:h-[200vh] md:h-[397vh] sm:h-[330vh] xl:h-[260vh] w-full flex justify-center py-10  bg-cyan-900   ">
      <article className=" w-[90%]  h-[340vh] sm:w-[90%] lg:w-[90%] lg:h-[180vh] xl:h-auto sm:h-[300vh] md:h-[300vh] md:w-[75%] bg-white rounded-lg bg-opacity-10  shadow-xl shadow-slate-800">
